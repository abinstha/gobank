...
func (s *APIServer) Run() {
	...
	router.Handle("/login", makeHTTPHandlerFunc(s.handleLogin)).Methods("POST")
...
// eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2NvdW50TnVtYmVyIjoxNDkyMzgxLCJleHBpcmVzQXQiOjE1MTYyMzkwMjJ9.AW33h63hXAZwQeT9MHQUUkc_Zd7diMYUNcMr-DxC0ig
